...
<header>
    <!-- Bootstrap -->
    <!-- Don't change these links or things will break. It's held together with duct tape -->
    ...
    <div class="container">
            ...
            <li class="nav-item">
                <a class="nav-link" href="index.php">
                    <img src="../res/MunchkinLabsLogo.jpg" class="navbar-brand brand-logo">
                </a>
            </li>
        </ul>
        ...
        <div class="row" id="rightNavbar">
            <ul class="navbar-nav right-align">
                ...
                if (isset($_SESSION["userId"])) {
                    ...
                    echo '<li class="nav-item"> <a class="nav-link" href="survey.php">Survey</a> </li>';
